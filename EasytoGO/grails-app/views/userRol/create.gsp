...
<html>
	...
	<div id="container">
			...
			<div class="row">
			 <div class="container">
                    <div class="col-lg-12">	
                        ...
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-dashboard"></i> En este Apartado se permite la Asignacion de roles a usuarios
                            </li>
                        </ol>
                    </div>
                </div>
		...
		<div id="create-userRol" class="content scaffold-create" role="main">
			...
			<g:form url="[resource:userRolInstance, action:'save']" class="form-horizontal"  >
				<fieldset class="form">
