...
<div class="fieldcontain ${hasErrors(bean: userInstance, field: 'fecNac', 'error')} required">
	<label for="fecNac">
		<g:message code="user.fecNac.label" default="Fecha de nacimiento" />
		<span class="required-indicator">*</span>
	</label>
...
<div class="fieldcontain ${hasErrors(bean: userInstance, field: 'fecVencCarnet', 'error')} required">
	<label for="fecVencCarnet">
		<g:message code="user.fecVencCarnet.label" default="Vencimiento del carnet de conducir" />
		<span class="required-indicator">*</span>
	</label>
	<g:datePicker name="fecVencCarnet" precision="month"  value="${userInstance?.fecVencCarnet}"  />
