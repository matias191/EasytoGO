...
<html lang="en">
  <head>
    ...
    <!-- Bootstrap theme -->
    <link href="${request.contextPath}/bootstrap/css/bootstrap-theme.min.css" rel="stylesheet">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#"><a href="http://grails.org"><asset:image src="easy_to_go.png"
				alt="Grails" /></a></a>
        </div>
