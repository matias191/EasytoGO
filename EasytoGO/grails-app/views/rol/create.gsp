...
<html>
	...
	<body>
			...
			<div class="row">
			 <div class="container">
                    <div class="col-lg-12">	
                        ...
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-dashboard"></i> En este Apartado se permite la Creacion de Nuevos roles de usuarios
                            </li>
                        </ol>
                    </div>
                </div>
		...
		<div id="create-rol" class="content scaffold-create" role="main">
			...
			<ul class="alert alert-dnager" role="alert">
				<g:eachError bean="${rolInstance}" var="error">
				<li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
				</g:eachError>
			</ul>
			</g:hasErrors>
			<g:form url="[resource:rolInstance, action:'save']"  class="form-horizontal">
				<fieldset class="form">
