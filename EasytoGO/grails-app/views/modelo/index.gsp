		...
		<div id="list-modelo" class="content scaffold-list" role="main">
			...
			<thead>
				...
				<g:each in="${modeloInstanceList}" status="i" var="modeloInstance">
					...
					<td>${fieldValue(bean: modeloInstance, field: "nombre")}</td>
					
					<td><g:link action="show" id="${modeloInstance.id}">${fieldValue(bean: modeloInstance, field: "marca")}</g:link></td>
			...
			<div class="pagination">
				<g:paginate total="${modeloInstanceCount ?: 0}" />
			</div>
		</div>
	</body>
</html>
