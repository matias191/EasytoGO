	...
	<body>
		...
		<div id="show-reserva" class="content scaffold-show" role="main">
			...
			<g:form url="[resource:reservaInstance, action:'delete']" method="DELETE">
				<div class="form-group">
				<span id="mascota-label" class="col-md-2 control-label"></span>
				<fieldset class="buttons col-md-5">
<%--					<g:link class="edit btn btn-success" action="edit" resource="${reservaInstance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>--%>
